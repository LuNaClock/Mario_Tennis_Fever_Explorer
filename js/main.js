import { characters, rackets, courts, tips, changelog, tierPurposeRecommendations } from "../data.js";
...
const translations = {
  ja: {
    ...
    section: { faq: { title: "よくある質問（検索意図別）", description: "「初心者向け」「Tier比較」「キャラ別」「勝てない時の対策」で、実際に検索されやすい疑問だけをまとめています。" }, characters: { title: "キャラクター一覧", description: "タイプ別の特徴やパラメータを比較できます。" }, rackets: { title: "ラケット一覧", description: "効果やタイミングを比較できます。" }, courts: { title: "コート一覧", description: "コートごとのたまあしとバウンドの特性を比較できます。" }, tips: { description: "試合で役立つ操作のポイントを素早く確認できます。" }, tier: { title: "Tier表", description: "キャラとラケットを自分基準でランク付けできます。" } },
    
    faq: { intro: "このFAQは、キャラ・ラケット・Tierを比較して勝率を上げるための入口です。迷ったら以下の質問から該当カテゴリを確認してください。", category: { beginner: "初心者向け", tier: "Tier比較", character: "キャラ別", losing: "勝てない時の対策" }, beginner: { q1: "Q. 初心者は最初にどのキャラを使うのが安定？", a1: "A. まずはオールラウンドのマリオかピーチが安定です。S Tierだけを追うより、操作ミス（前に出すぎてロブを抜かれる・ため打ちしすぎる）を減らす方が勝率が上がります。", q2: "Q. 何を優先して覚えるとランクマで通用する？", a2: "A. 「球種の打ち分け」「スタミナ管理」「早めのポジション修正」の3つを先に覚えるのがおすすめです。スマッシュ狙いだけに偏ると失点が増えます。" }, tier: { q1: "Q. S TierとA Tierの差はどこで出る？", a1: "A. 同格帯では「苦手対面の少なさ」と「ミスしても立て直せる性能」で差が出ます。例えばS Tierは不利コートでも崩れにくく、A Tierは得意条件で一気に強い傾向です。", q2: "Q. Tier表はそのまま信じていい？", a2: "A. 固定Tierは目安です。自分の操作精度や使用コート（ハード/クレー/グラス）で体感は変わるので、Tier欄で条件を切り替えて確認するのが安全です。" }, character: { q1: "Q. ワルイージやロゼッタみたいなリーチ型が苦手です。", a1: "A. 横に振るより前後に揺さぶるのが有効です。深いトップスピン→浅いスライスで走らせると、長リーチでも体勢を崩しやすくなります。", q2: "Q. スピード型（ヨッシー、キノピオ）対面で振り遅れます。", a2: "A. 強打の読み合いより、早め入力でコース優先に切り替えるのが安定です。狙いをサイドに固定しすぎる操作ミスを減らすと失点が下がります。" }, losing: { q1: "Q. 連敗中はどこから見直すべき？", a1: "A. まず「失点パターン」を3つに絞って修正します。例: リターンを中央に返しすぎる、前詰めしすぎる、スピン不足で短くなる。1項目ずつ直す方が復調が早いです。", q2: "Q. 相手の妨害ラケットに崩される時の対処は？", a2: "A. 妨害効果を受ける前提で、球速より返球コースを優先します。特にバウンド時発動タイプには、無理な強打より深い返球で時間を作るのが有効です。" } },
  ...
  en: {
    ...
    section: { faq: { title: "FAQ (by Search Intent)", description: "Only high-intent questions are listed under Beginner, Tier comparison, Character matchups, and losing-streak fixes." }, characters: { title: "Character List", description: "Compare traits and parameters by type." }, rackets: { title: "Racket List", description: "Compare effects and trigger timing." }, courts: { title: "Court List", description: "Compare each court's ball speed and bounce characteristics." }, tips: { description: "Quickly review useful operation tips for matches." }, tier: { title: "Tier Board", description: "Rank characters and rackets by your own criteria." } },
    faq: { intro: "This FAQ helps you raise win rate by connecting common search questions to character, racket, and tier decisions.", category: { beginner: "For Beginners", tier: "Tier Comparison", character: "By Character", losing: "When You're Not Winning" }, beginner: { q1: "Q. Which character is safest for beginners?", a1: "A. Mario or Peach (all-around) is a stable start. Reducing mistakes like over-advancing into lobs or overcharging shots improves consistency more than forcing only S Tier picks.", q2: "Q. What should I learn first for ranked matches?", a2: "A. Learn shot variation, stamina control, and early repositioning first. Focusing only on smashes usually increases unforced errors." }, tier: { q1: "Q. What is the practical gap between S Tier and A Tier?", a1: "A. The gap appears in matchup coverage and recovery from mistakes. S Tier tends to stay stable on unfavorable courts, while A Tier spikes in favorable conditions.", q2: "Q. Should I trust a tier list as-is?", a2: "A. Use it as a baseline. Results change with your execution and court type (hard/clay/grass), so check tier settings by condition." }, character: { q1: "Q. I struggle against long-reach picks like Waluigi and Rosalina.", a1: "A. Pressure front-back depth instead of only side movement. Deep topspin into short slice can break long-reach stability.", q2: "Q. I get rushed by speed types (Yoshi, Toad).", a2: "A. Use earlier inputs and prioritize safe placement over power reads. Avoid the common mistake of locking shots to one sideline." }, losing: { q1: "Q. Where should I start when I'm on a losing streak?", a1: "A. Review three recurring errors first, such as center-only returns, over-committing at net, or short balls from weak spin. Fixing one pattern at a time restores form faster.", q2: "Q. How do I deal with disruptive rackets?", a2: "A. Assume disruption will trigger and prioritize return direction over raw speed. Against on-bounce effects, deep neutral balls are safer than risky power shots." } },
