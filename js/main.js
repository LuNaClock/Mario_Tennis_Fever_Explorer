...
const rankedCourtObservedSequences = [
  ...
  ["ワンダー", "カーペット", "グラス", "ウッド", "飛行船", "ハード", "ブロック", "ファクトリー", "クレイ", "サンド", "フォレスト"],
];
