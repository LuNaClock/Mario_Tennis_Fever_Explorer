export const characters = [
  ...
  export const rackets = [
    ...
    },
    {
      ...
      text: { ja: "バウンドした場所から炎をまわりにまきちらす。ふれるとアチチ！と走りまわる。", en: "" },
    ...
    },
    {
      ...
      text: { ja: "バウンドした場所に氷の床を作る。氷で足が滑って強いショットを打ち返すと転ぶ", en: "" },
    ...
    },
    {
      ...
      text: { ja: "バウンドした場所に雷が発生。ふれると体がビリビリしてしばらく動けなくなる。", en: "" },
    ...
    },
    {
      ...
      text: { ja: "バウンドした場所に強風が発生。ふれるとふきとばされる。ボールが当たると軌道が変わる。", en: "" },
     ...
     text: { ja: "バウンドした場所にドロの床を作って移動づらくなる。ボールもはねづらく体力も減る。", en: "" },
     ...
     },
    {
     ...
     text: { ja: "バウンドした場所のまわりにマメキノコを出現させる。ふれると体が小さくなる", en: "" },
    ...
    },
    {
        ...
        text: { ja: "使うとしばらくの間打つときにファイアボールを発生させる。ふれるとアチチ!と走り回る", en: "" },
      ...
      },
      {
        ...
        text: { ja: "使うとしばらくの間打つときにアイスボールを発生させる。ふれるとこおって動けなくなる", en: "" },
      ...
      },
      {
        ...
        text: { ja: "使うとしばらくの間コート上のジャマを受け付けない無敵になる。移動も少し速くなる", en: "" },
      ...
      },
      {
        ...
        timing: "不明",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "使うとしばらくの間打つときにたつまきを発生させる。ふれたものはふきとばされる", en: "" },
      ...
      },
    {
      ...
      text: { ja: "バウンドした場所にサンボが出現させる。ボールを当てるとくずれる", en: "" },
    ...
    },
    {
      ...
      text: { ja: "使うと自分の分身を作る。しばらくの間勝手にうごいてボールを打ち返してくれる", en: "" },
    ...
    },
    {
        ...
        timing: "不明",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "バウンドした場所にファイアバーを出現させる。ふれるとアチチ！と走り回る。", en: "" },
      ...
      },
      {
        ...
        timing: "バウンド時",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "バウンドした場所のまわりに氷をばらまく。ふれるとこおって動けなくなる", en: "" },
      ...
      },
      {
        ...
        timing: "不明",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "使うとしばらくの間打つときにボールをビリキューに変える。ビリキュー同氏は雷でつながる。", en: "" },
      ...
      },
      {
        ...
        timing: "不明",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "使うとしばらくの間ショットを曲げる強化がつく。トップスピンやロブも曲がる", en: "" },
      ...
      },
      {
        ...
        timing: "不明",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "前を見づらくするインクをまく。インク内で打ち返す時やインクがついたボールを打つ時も効果あり", en: "" },
      ...
      },
      {
        ...
        text: { ja: "バウンドした時とカウンターした時にバナナの皮をまく。ふむとすべってころんでしまう。", en: "" },
      ...
      },
      {
        ...
        timing: "不明",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "バウンドした場所に火山口を作って岩をふらせる。ふれるとアチチ!と走りまる", en: "" },
      ...
      },
      {
        ...
        timing: "不明",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "使うとしばらくの間打ったボールと自分の姿が相手に見えなくなる", en: "" },
      ...
      },
      {
        ...
        timing: "即時",
        effect: { ja: "※発売後確認予定", en: "To be confirmed after release." },
        text: { ja: "使うとしばらくの間すばやく飛びつける強化がつく。はなれたボールにも追いつける", en: "" },
      ...
      },
      {
        ...
        text: { ja: "使うとしばらくの間打つ時にボールを違う形に変える。バウンドのときあちこちにはねる", en: "" },
      ...
      },
      {
        ...
        text: { ja: "バウンドした場所にトゲゾーを出現させる。トゲゾーは歩いて近づいてくる", en: "" },
      ...
      },
      {
        ...
        text: { ja: "使うとしばらくの間打つ時にボールをkillerに変える。キラーは高速でまっすぐ飛ぶ", en: "" },
      ...
      },
      {
        ...
        text: { ja: "バウンドした場所にドッスンを出現させる。近づくとふみつぶされてしまう", en: "" },
      ...
      },
      {
        ...
        text: { ja: "使うとしばらくの間相手をコート奥に押し出す強化がつく。ショットの威力も少しあがる。", en: "" },
      ...
      },
    {
      ...
      text: { ja: "使うとしばらくの間コート上のジャマを受けないメタル状態に。ショット威力が少しあがる", en: "" },
    ...
    },
    {
        ...
        category: "妨害",
        timing: "不明",
        effect: { ja: "使用する度、全ラケットのからランダムで効果が発生", en: "" },
        text: { ja: "ショットするまでどの効果が出るか分からない。使うたびに効果がかわる", en: "" },
      ...
      },
    {
      ...
      text: { ja: "使うとしばらくの間自分のまわりをぐるぐるまわってボールを打ち返してくれる", en: "" },
