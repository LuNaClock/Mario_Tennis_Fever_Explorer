export const characters = [
  ...
  export const rackets = [
     ...
     },
    {
     ...
     category: "妨害",
     timing: "バウンド時",
     effect: { ja: "縦に動く4列のマメキノコを設置。触れると体が小さくなり、押し出されやすく、ボールにとびつきやすくなる。", en: "Places four vertical-moving columns of Mini Mushrooms. Touching them shrinks you, makes you easier to push back, and makes it easier to dive toward the ball." },
    ...
    },
    {
      ...
      },
      {
        ...
        category: "妨害",
        timing: "即時",
        effect: { ja: "打球時、スライドフットワーク / とびつきショット / ドロップショットを除く球種で相手を押し出す強化状態になる。", en: "On hit, shot types other than slide footwork, diving shots, and drop shots gain a strengthened effect that pushes opponents backward." },
