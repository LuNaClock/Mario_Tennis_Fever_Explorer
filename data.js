export const characters = [
    ...
    },
    {
      ...
      special: { ja: "ロブ強化。浮遊:チャージ中の移動速度が速く、フィーバーラケットの床効果を無効にする", en: "" },
    ...
    },
    {
      ...
      special: { ja: "ライジング時、各ショット強化。浮遊:チャージ中の移動速度が速く、フィーバーラケットの床効果を無効にする", en: "" },
    ...
    },
    {
      ...
      special: { ja: "浮遊:チャージ中の移動速度が速く、フィーバーラケットの床効果を無効にする", en: "" },
    ...
    },
    {
      ...
      special: { ja: "ロブチャージ速度向上。浮遊:チャージ中の移動速度が速く、フィーバーラケットの床効果を無効にする", en: "" },
