export const characters = [
  ...
  export const rackets = [
    ...
    },
    {
      ...
      category: "妨害",
      timing: "バウンド時",
      effect: { ja: "氷の床を設置。踏んでいる間滑って切り替えししづらくなる。床上でスーパーチャージショットを「打ち返す」と短時間行動不可", en: "Creates an icy floor. While on it, you slide and struggle to change direction. Using a power shot briefly prevents actions." },
    ...
    },
    {
      ...
      category: "妨害",
      timing: "バウンド時",
      effect: { ja: "動く竜巻を設置。触れると小時間操作不能+ダメージ。竜巻にボールが当たると軌道が変化する", en: "Places a moving tornado. Touching it briefly disables controls and deals damage. If the ball hits it, the ball’s trajectory changes." },
     ...
     category: "妨害",
     timing: "バウンド時",
     effect: { ja: "ドロの床を設置。踏んでいる間移動速度低下+ダメージ。床上でボールのバウンド時、バウンドの高さが低くなる。", en: "Places a mud floor. While standing on it, movement speed is reduced and damage is taken." },
     ...
     },
    {
     ...
     category: "妨害",
     timing: "バウンド時",
     effect: { ja: "縦に動く4列のマメキノコを設置。触れると体が小さくなり、返球時に押し出されやすくなる。リーチが短くなる為、とびつきやすくもなる。", en: "Places four vertical-moving columns of Mini Mushrooms. Touching them shrinks you, makes you easier to push back, and makes it easier to dive toward the ball." },
    ...
    },
    {
      ...
      },
      {
        ...
        category: "妨害",
        timing: "即時",
        effect: { ja: "打った地点から前方に進む竜巻を発生。触れると小時間操作不能+ダメージ。竜巻にボールが当たると軌道が変化する", en: "Creates a tornado that moves forward from the hit point. Contact causes brief control loss + damage. Balls that hit it change trajectory." },
    ...
    },
    {
      ...
      category: "強化",
      timing: "即時",
      effect: { ja: "分身を自コートに生成。分身位置はプレイヤー位置に依存。分身は自動で返球し、基本的に別ラケットの攻撃ギミックによる影響を受けない。", en: "Creates a clone on your side of the court. The clone's position depends on your position, and it automatically returns balls." },
    ...
    },
    {
      ...
      },
      {
        ...
        category: "妨害",
        timing: "バウンド時",
        effect: { ja: "左右に3つずつ、氷を放射状に設置。触れると小時間行動不可 + ダメージ。氷上でバウンドすると球が変化し、打ち返すと同様の効果が発生。", en: "Places 3 ice shards to each side in a radial pattern. Contact causes brief immobilization + damage." },
      ...
      },
      {
        ...
        category: "強化",
        timing: "即時",
        effect: { ja: "トップ・スライス・ドロップ・ロブの各球種でよく曲がるようになる。ロブは着弾速度が高速化し、着弾後は曲がっている方向側へバウンドする", en: "Topspin, slice, drop, and lob shots all curve more. Lobs also gain faster landing speed." },
      ...
      },
      {
        ...
        category: "妨害",
        timing: "即時",
        effect: { ja: "打球時、スライドフットワーク・とびつき・ドロップショットを除く球種で、相手を押し出す強化状態になる。", en: "On hit, shot types other than slide footwork, diving shots, and drop shots gain a strengthened effect that pushes opponents backward." },
